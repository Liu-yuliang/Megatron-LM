...
RUN_BASE="${RUN_BASE:-/mnt/shared-storage-gpfs2/plm-gpfs/ylliu/runs/concept_olmo3_v22_vq_20260527}"
...
export MODEL=olmo3
export JOB_NAME="${JOB_NAME:-concept-olmo3-v22vq-$(date +%m%d%H%M)}"
...
export CONCEPTLM_SPECIAL_LAYERS="${CONCEPTLM_SPECIAL_LAYERS:-4}"
...
export SAVE_INTERVAL="${SAVE_INTERVAL:-7153}"
