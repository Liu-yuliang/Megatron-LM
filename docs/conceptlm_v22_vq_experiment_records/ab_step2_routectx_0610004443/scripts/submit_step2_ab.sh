...
AB_ROOT="/mnt/shared-storage-gpfs2/plm-gpfs/ylliu/scale_up/train_conceptlm_V22_olmo_7B/ab_step2_routectx_0610004443"
STAMP="0610004443"

BASE_REPO="/mnt/shared-storage-gpfs2/plm-gpfs/jyhuang/works/ab_worktrees/conceptlm_step2_base_365cd0744_0610004443"
NEW_REPO="/mnt/shared-storage-gpfs2/plm-gpfs/jyhuang/works/ab_worktrees/conceptlm_step2_new_88902b7d4_0610004443"
BASE_COMMIT="365cd0744005126b1288b0e044a6d66d8d2992dd"
NEW_COMMIT="88902b7d4a47e567f59bbac994843def8e0be2b0"
...
submit_one() {
  ...
  local repo="$2"
  local commit="$3"
  local job_name="c22vq-s2-${label}-16g-${STAMP}"
  local run_base="/mnt/shared-storage-gpfs2/plm-gpfs/jyhuang/runs/concept_olmo3_v22_vq_step2_${label}_16g_${STAMP}"
