...
AB_ROOT="/mnt/shared-storage-gpfs2/plm-gpfs/ylliu/scale_up/train_conceptlm_V22_olmo_7B/ab_step3_decoderroute_0610012914"
STAMP="0610012914"

BASE_REPO="/mnt/shared-storage-gpfs2/plm-gpfs/jyhuang/works/ab_worktrees/conceptlm_step3_base_e8c0e9e32_0610012914"
NEW_REPO="/mnt/shared-storage-gpfs2/plm-gpfs/jyhuang/works/ab_worktrees/conceptlm_step3_new_1ca63d1cc_0610012914"
BASE_COMMIT="e8c0e9e3246820da5133485b60bfc58c7e4292d0"
NEW_COMMIT="1ca63d1cc17d2f69afe0ae8588a8c0da8dcfdadc"
...
submit_one() {
  ...
  local repo="$2"
  local commit="$3"
  local job_name="c22vq-s3d-${label}-16g-${STAMP}"
  local run_base="/mnt/shared-storage-gpfs2/plm-gpfs/jyhuang/runs/concept_olmo3_v22_vq_step3d_${label}_16g_${STAMP}"
...

{
  ...
  echo "previous_pass=/mnt/shared-storage-gpfs2/plm-gpfs/ylliu/scale_up/train_conceptlm_V22_olmo_7B/ab_step2_routectx_rerun_0610005716/RESULT.md"
  echo "step3_change=decoder route dispatch plan; module registration and execution math unchanged"
